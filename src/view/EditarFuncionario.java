...
public class EditarFuncionario {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditarFuncionario window = new EditarFuncionario( funcionario,  index);
	 ...
	 */
	public EditarFuncionario(Funcionario funcionario, int index) {
		initialize(funcionario, index);
	}
	...
	private void initialize(Funcionario funcionario, int index) {
		...
		txtName  = new JTextField(funcionario.getNome());
		...
		txtCodigo = new JTextField(funcionario.getCodigo());
		...
		txtTelefone.setValue(funcionario.getTelefone());
		...
		txtAdress   = new JTextField(funcionario.getEndereco());
		...
		txtValorValeAlimentacao	= new JtextFieldSomenteNumeros(8);
		txtValorValeAlimentacao.setText(funcionario.getValeAlimentacao());
		...
		if(funcionario.getValeAlimentacao().equals(null)) {
		...
		txtValorValeRefeicao = new JtextFieldSomenteNumeros(8);
		txtValorValeAlimentacao.setText(funcionario.getValeRefeicao());
		...
		txtValorValeTransporte = new JtextFieldSomenteNumeros(8);
		txtValorValeTransporte.setText(funcionario.getValeTransporte());
		...
		btnCancel.setBounds(310, 410, 130, 35);
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					funcionario.setDisciplina(boxDisciplina.getSelectedItem().toString());
					...
					ListaFuncionario.editarNaListaFuncionario();
				}
			}
		});
